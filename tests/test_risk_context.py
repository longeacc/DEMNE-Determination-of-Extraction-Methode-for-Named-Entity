...
def test_negation_detection():
    ...
    # Patterns actually detected (see NEGATION_PATTERNS in E_risk_context.py)
    # "non" alone is intentionally excluded to avoid clinical false positives
