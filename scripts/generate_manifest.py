...
story += [
    ...
    paragraph("<b>Determination of Extraction Method for Named Entity</b> â€” pipeline "
      "NLP cascadÃ© RÃ¨gles â†’ ML â†’ LLM pour l'extraction de biomarqueurs "
      "oncologiques sur comptes-rendus cliniques."),
    Spacer(1, 6),
    paragraph(f"<b>Version</b> : DuraXELL 2.0   |   <b>Date</b> : {date.today().isoformat()}   "
...
story += [paragraph("<b>Environnement recommandÃ©</b> : Python 3.12 via le venv embarquÃ© "
...
CMD_DOC = [
    ("info", "Affiche la version, la racine du projet, les chemins GS/Pred par dÃ©faut, "
              "la liste des entitÃ©s et l'Ã©tat du fichier de configuration.",
     "python main.py info"),
    ("metrics", "Lance en sÃ©quence les 5 scorers : Te, He, Freq, R, Feas. "
    ...
    ("tree", "Lit les CSVs de Results/, lance la k-fold de stabilitÃ© (k=3) puis "
    ...
    ("corpus", "Parse un dossier BRAT et affiche par entitÃ© : nombre d'occurrences "
                "et top-3 valeurs uniques.",
     "python main.py corpus\n"
     "python main.py corpus --path data/ESMO2025/Breast/CHIR/training_set_chir_GS"),
    ("rest-config", "SÃ©rialise (ou recharge) la liste d'entitÃ©s sÃ©lectionnÃ©es, les "
    ...
    ("rest", "Lance uniquement demo_rest.py (compatibilitÃ© avec versions antÃ©rieures).",
     "python main.py rest"),
    ("export-csv", "RÃ©gÃ©nÃ¨re Results/decision_summary.csv sans relancer le pipeline. "
...
story += [Spacer(1, 6),
          paragraph("<b>Arbre de dÃ©cision (E_creation_arbre_decision.py)</b> :")]
story += [code(
    "Te â‰¥ 0.10  ?\n"
...
story += [paragraph("RÃ©sultat actuel du pipeline sur "
