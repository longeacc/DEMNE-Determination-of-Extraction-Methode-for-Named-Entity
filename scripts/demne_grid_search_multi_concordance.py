...
MACCROBAT = [
    ...
    Entity("Administration",               0.3270, 0.9101, 0.0006, 0.0021, 0.182, "TBM",   0.01, 0.00, 0.00, 175),
    ...
    Entity("Biological_structure",         0.3540, 0.9511, 0.0131, 0.0354, 0.197, "TBM",   0.01, 0.00, 0.02, 2953),
    ...
    Entity("Date",                         0.1910, 0.9778, 0.0106, 0.0088, 0.197, "TBM",   0.00, 0.00, 0.02, 735),
    Entity("mac_Detailed_description",         0.3860, 0.6707, 0.0795, 0.0350, 0.141, "TBM",   0.00, 0.00, 0.13, 2920),
    Entity("mac_Diagnostic_procedure",         0.3110, 0.9395, 0.0759, 0.0551, 0.199, "TBM",   0.01, 0.00, 0.12, 4598),
    ...
    Entity("Duration",                     0.2260, 0.9578, 0.0044, 0.0034, 0.192, "TBM",   0.00, 0.00, 0.01, 283),
    Entity("Family_history",               0.1040, 0.5680, 0.0000, 0.0010, 0.114, "RULES", 0.00, 0.00, 0.00, 81),
    ...
    Entity("Lab_value",                    0.3150, 0.9465, 0.1507, 0.0341, 0.196, "TBM",   0.01, 0.00, 0.25, 2848),
    Entity("Medication",                   0.3860, 0.7311, 0.0194, 0.0129, 0.149, "TBM",   0.00, 0.00, 0.03, 1080),
    Entity("Nonbiological_location",       0.3050, 0.8956, 0.0000, 0.0043, 0.180, "TBM",   0.00, 0.00, 0.00, 356),
    Entity("Personal_background",          0.2490, 0.3506, 0.0000, 0.0007, 0.070, "RULES", 0.00, 0.00, 0.00, 57),
    Entity("Severity",                     0.4800, 0.9377, 0.0016, 0.0045, 0.188, "TBM",   0.01, 0.00, 0.00, 376),
    ...
    Entity("Therapeutic_procedure",        0.3110, 0.7365, 0.0228, 0.0124, 0.150, "TBM",   0.00, 0.01, 0.03, 1036),
]
...
QUEARO = [
    ...
    Entity("PROC",  0.3070, 0.7047, 0.0125, 0.0559, 0.152, "TBM",   0.00, 0.03, 0.01, 608),
    Entity("ANAT",  0.3590, 0.4500, 0.0035, 0.0469, 0.099, "TBM",   0.00, 0.01, 0.00, 510),
    Entity("CHEM",  0.2730, 0.2131, 0.0038, 0.0315, 0.049, "TBM",   0.00, 0.01, 0.00, 342),
    Entity("DEVI",  0.1570, 0.0647, 0.0000, 0.0032, 0.014, "RULES", 0.00, 0.00, 0.00, 35),
    Entity("LIVB",  0.3090, 0.4013, 0.0056, 0.0298, 0.086, "TBM",   0.00, 0.02, 0.00, 324),
    Entity("PHYS",  0.2560, 0.2341, 0.0038, 0.0145, 0.050, "RULES", 0.02, 0.01, 0.00, 158),
    Entity("PHEN",  0.2170, 0.0497, 0.0000, 0.0045, 0.011, "RULES", 0.00, 0.00, 0.00, 49),
    Entity("GEOG",  0.2260, 0.0562, 0.0176, 0.0047, 0.012, "RULES", 0.00, 0.06, 0.00, 51),
    Entity("OBJC",  0.1850, 0.0759, 0.0000, 0.0035, 0.016, "RULES", 0.00, 0.00, 0.00, 38),
]
...
CANTEMIST = [
    ...
    Entity("Traitement_specifique_du_cancer",                                    0.174, 0.8411, 0.1892, 0.0071, 0.170, "LLM",   0.10, 0.01, 0.29, 205),
    ...
    Entity("Stade_metastatique_avec_localisations",                              0.111, 0.8196, 0.0525, 0.0029, 0.164, "LLM",   0.05, 0.10, 0.03, 83),
    Entity("Statut_tabagique",                                                   0.100, 0.5883, 0.0500, 0.0005, 0.118, "LLM",   0.50, 0.00, 0.00, 14),
    ...
    Entity("Biomarqueurs_therapeutiques",                                        0.104, 0.7193, 0.3645, 0.0010, 0.144, "LLM",   0.00, 0.14, 0.54, 29),
